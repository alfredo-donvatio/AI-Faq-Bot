...
def es_pregunta_valida(pregunta: str, client) -> bool:
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user","content": f"¿Esta pregunta está relacionada con energía eléctrica, comercializadoras de luz, tarifas eléctricas, Don Vatio, zirconite, facturas de electricidad o el sector energético español? Pregunta: '{pregunta}'"}
            ]
    )
